      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center">
            <h1 className="text-2xl font-bold text-youth-purple">Youth Pulse</h1>
          </Link>

          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-8">
            <Link to="/" className="font-medium hover:text-youth-purple transition-colors">Home</Link>
            <Link to="/education" className="font-medium hover:text-youth-purple transition-colors">Education</Link>
            <Link to="/culture" className="font-medium hover:text-youth-purple transition-colors">Culture</Link>
            <Link to="/technology" className="font-medium hover:text-youth-purple transition-colors">Technology</Link>
            <Link to="/environment" className="font-medium hover:text-youth-purple transition-colors">Environment</Link>
          </div>
